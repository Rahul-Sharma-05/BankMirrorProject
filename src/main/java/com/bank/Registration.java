	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			PreparedStatement ps = con.prepareStatement(
					"Insert into Customer (CustomerId, Name, Password, MobileNumber, Email, Address) Value (?,?,?,?,?,?)");
			...
			if (work > 0) {
				...
				try {
					...
					String htmlMessage = "<p>Congratulations <strong>" + name + "</strong></p>"
							+ "<p>Welcome to <strong>Trust Bank!</strong></p>" + "<p>Thanks for choosing our bank.</p>"
							+ "<p>You successfully completed Registration process.</p>"
							+ "<p>Your Customer Id is: <strong style='font-size: 18px;'>" + GeneratedCustomerId
							+ "</strong></p>" + "<p>Keep this Customer Id secure for future purpose.</p>" + "<br>"
							+ "<br>" + "<br>" + "<p>Thank you!!</p>";
				...
				request.setAttribute("message",
						"Registration Completed Successfully!! Your Customer ID has been sent to your registered E-mail Id. Please Login!");
